<template>
  <div class="header">
    <div class="brand" v-on:dblclick="popOut()">
      <span class="brand-mark"><img src="/images/shanna-auth-logo.svg" alt="SHANNA Authenticator" /></span>
      <span class="brand-copy">
        <strong>{{ i18n.extName }}</strong>
        <small>SHANNA STUDIO</small>
      </span>
    </div>
    <p class="brand-tagline">Secure your accounts with two-factor authentication</p>
    <div class="header-actions" v-show="!isPopup()">
      ...
      >
        <IconPlus /><span>{{ i18n.add_code }}</span>
      </div>
      <div
        class="icon"
        id="i-lock"
